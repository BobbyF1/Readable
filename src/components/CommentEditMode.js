...
class CommentEditMode extends Component {
				constructor(props) {
								super(props);
								this.handleEditCommentChange = this
												.handleEditCommentChange
												.bind(this);
								this.handleClosedValidationModal = this
												.handleClosedValidationModal
												.bind(this);
								this.editCommentOK = this
												.editCommentOK
												.bind(this)
								this.state = {
								...
								return (
												<div>
																<ValidationFailureModal
																				open={this.state.openValidationErrorModal}
																				validationMessage={"Comments can't be blank."}
																				...
																				<FormGroup row>
																								...
																								<Col sm={10}>
																												<Input
																																...
																																invalid={(this.props.editComment === "")}/>
																												<Button
																																...
																																size="sm"
																																color="primary"
																																onClick={(e) => this.editCommentOK()}><TiTick/>
																																Done
																												</Button>
																												<Button
																																className="btn float-right"
																																...
																																size="sm"
																																color="secondary"
																																onClick={(e) => this.props.editCommentCancel()}><FaTimesCircle/>
																																Cancel
																												</Button>
																								</Col>
																				</FormGroup>
